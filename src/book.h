...
class Book
{
  public:
	...
	/**
	 * @brief Check if a book is empty (has no pages or hasn't open any
	 * books)
	 *
	...
	/**
	 * @brief Move to the NUMth page, or the first page if NUM is negative
	 * and the last page if NUM is larger than (the number of page - 1).
	 *
